...
#define VIRT_PAGE_OFFSET(X) ((X) & 0x00000FFF)      // offset
#define VIRT_PAGE_TABLE(X)  (((X) >> 12) & 0x3FF)   // pt_index
#define VIRT_PAGE_DIR(X)    (((X) >> 22) & 0x3FF)   // pd_index
#define CR3_TO_PAGE_DIR(X)  ((X) & 0xFFFFF000)    // pd
#define MMU_ENTRY_PADDR(X)  ((X) << 12)             // dirección física de PF O PT 
