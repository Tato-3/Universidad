...
DPL: nivel de privilegio del código que lo puede llamar

Offset: lugar donde inicia la rutina de atención de la interrupción

P: flag de válidez 

Selector: selector de segmento del codigo que atiende la interrupción

D: Tamaño de la interrupción 

Si D=0: 16bits

Si D=1: 32bits

El offset es la dirección de memoria del código que resuelve la interrupción, así que toma los valores de la dirección de la rutina.
